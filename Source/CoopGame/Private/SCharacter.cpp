...
ASCharacter::ASCharacter()
{
	...
	WeaponAttcahmentSocketName = "WeaponSocket";
}
...
void ASCharacter::BeginPlay()
{
	...
	if (GetLocalRole() == ROLE_Authority)
	{
		...
		CurrentWeapon = GetWorld()->SpawnActor<ASWeapon>(StartWeaponClass, FVector::ZeroVector, FRotator::ZeroRotator, SpawnParameter);
		if (CurrentWeapon)
		{
			CurrentWeapon->SetOwner(this);
			CurrentWeapon->AttachToComponent(GetMesh(), FAttachmentTransformRules::SnapToTargetNotIncludingScale, WeaponAttcahmentSocketName);
		}
	}
}
